...
var ModuloPrecoBoleto = function (elemento) {
	Modulo.call(this);
	this.opcoes({
		"ativo": true
	});
};
exports.ModuloPrecoBoleto = ModuloPrecoBoleto;
...
var ModuloPrecoDe = function (elemento) {
	Modulo.call(this);
	this.opcoes({
		"ativo": true
	});
};
exports.ModuloPrecoDe = ModuloPrecoDe;
// subclasse extende superclasse
...
ModuloPrecoDe.prototype.atualizar = function (novoSku) {
	var precoDe = (novoSku.listPrice / 100), precoPor = (novoSku.bestPrice / 100);
...
var ModuloPrecoParcelado = function (elemento) {
	Modulo.call(this);
	this.opcoes({
		"auto": false,
		"ativo": false,
...
exports.ModuloPrecoParcelado = ModuloPrecoParcelado;
// subclasse extende superclasse
...
ModuloPrecoParcelado.prototype.desenhar = function () {
	...
	$('<span />', {
		'html': '<strong class="numero-de-parcelas"></strong> de '
...
var ModuloPrecoPor = function (elemento) {
	Modulo.call(this);
	this.opcoes({
		"ativo": true
	});
};
exports.ModuloPrecoPor = ModuloPrecoPor;
// subclasse extende superclasse
