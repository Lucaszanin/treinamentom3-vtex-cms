var slider = {
	...
	"bannerHome":function(elementoPaiDoBanners){
		let $elemento = (typeof elementoPaiDoBanners !== "undefined")?$(elementoPaiDoBanners):$('.main-gallery');
	...
	"naveguePorCategorias":function(elementoPaiDoBanners){
		let $elemento = (typeof elementoPaiDoBanners !== "undefined")?$(elementoPaiDoBanners):$('.main-gallery');
	...
	"barraDeVantagens":function(barraDeVantagens){
		let $elemento = (typeof barraDeVantagens !== "undefined")?$(barraDeVantagens):$('.main-gallery');
	...
	"produtopThumbs":function(thumbs){

		let $elemento = (typeof thumbs !== "undefined")?$(thumbs):$('.main-gallery');
	...
	"navegacaoInstitucional":function(elemento){
		let $elemento = (typeof elemento !== "undefined")?$(elemento):$('.navegacao-institucional');
