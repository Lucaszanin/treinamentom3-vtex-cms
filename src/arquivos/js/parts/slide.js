export default {
	...
	slideResponsivo(
		...
		slidesToShowDesktop =
			typeof slidesToShowDesktop !== "undefined"
				? slidesToShowDesktop
				: 4;
		slidesToShow992 =
	...
	bannerHome(elementoPaiDoBanners) {
		let $elemento =
	...
	naveguePorCategorias(elementoPaiDoBanners) {
		let $elemento =
			typeof elementoPaiDoBanners !== "undefined"
				? $(elementoPaiDoBanners)
				: $(".main-gallery");
	...
	barraDeVantagens(barraDeVantagens) {
		let $elemento =
	...
	navegacaoInstitucional(elemento) {
		let $elemento =
