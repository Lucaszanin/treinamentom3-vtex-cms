...
var paginaCategoria = {
	...
	'filterMobileExtraInfo': function(){
	...
	'reposicionarSelectDeOrdenacao': function(){
	...
	'smartResearch':function(){
		...
		$(document).on('vsr-request-end', prateleira.atualziar.bind(prateleira));
		$(window).on('finished-upadte-filter', prateleira.atualziar.bind(prateleira));
...
module.exports = paginaCategoria;
